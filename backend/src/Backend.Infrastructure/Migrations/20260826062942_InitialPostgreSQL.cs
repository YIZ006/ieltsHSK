    ...
    public partial class InitialPostgreSQL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ielts_vocabularies", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "ielts_vocabulary_imports",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ielts_vocabulary_imports", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vocabulary_json = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ielts_vocabularies_topic",
                table: "ielts_vocabularies",
                column: "topic");

            migrationBuilder.CreateIndex(
                name: "ix_ielts_vocabularies_word_meaning",
                table: "ielts_vocabularies",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_test_submissions_user_id_submitted_at",
